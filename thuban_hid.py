    ...
    def __init__(self, mouse_handle_name, keyboard_handle_name):
        ...
        self.GetKeySC = \
            {'a': 30, 'b': 48, 'c': 46, 'd': 32, 'e': 18, 'f': 33, 'g': 34, 'h': 35, 'i': 23, 'j': 36, 'k': 37, 'l': 38,
             ...
             '`': 41, '1': 2, '2': 3, '3': 4, '5': 6, '7': 8, '8': 9, '9': 10, '0': 11, '-': 12, '=': 13,
             'backspace': 14, 'enter': 284,
             'tab': 15, 'capslock': 58, 'lshift': 42, 'lctrl': 29, 'lwin': 347, 'lalt': 56, 'space': 57, '한영': 114,
             'rctrl':285,'ralt':312,
             'esc': 1, 'f1': 59, 'f2': 60, 'f3': 61, 'f4': 62, 'f5': 63, 'f6': 64, 'f7': 65, 'f8': 66, 'f9': 67,
